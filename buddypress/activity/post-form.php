...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary" class="clearfix">
	...
	<div id="whats-new-content">
		...
		<div class="">
			<h5 class="col-md-6 no-margin">Status Update</h5>
			<?php if (bp_is_active('groups') && !bp_is_my_profile() && !bp_is_group()): ?>
				<div id="whats-new-post-in-box" class="col-md-6 form-inline col-no-padding"> 
		...
		<div class="">
			<div id="whats-new-textarea" class="form-group col-md-10">
				<textarea class="form-control bp-suggestions" name="whats-new" id="whats-new" rows="3"><?php if (isset($_GET['r'])): ?>@<?php echo esc_textarea($_GET['r']); ?><?php endif; ?></textarea>
			</div>

			<div id="whats-new-options" class="col-md-2 ">
				<div id="whats-new-submit" class=""> 
