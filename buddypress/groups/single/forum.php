	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul class="nav nav-pills">
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<li>
					<a href="#post-new" class="show-hide-new"><?php _e( 'New Topic', 'myfossil' ); ?></a>
				</li>
			...
			<li id="forums-order-select" class="pull-right form-inline last filter">
				...
				<label for="forums-order-by"><?php _e( 'Order By:', 'myfossil' ); ?></label>
				<select class="form-control input-sm" id="forums-order-by">
					<option value="active"><?php _e( 'Last Active', 'myfossil' ); ?></option>
					<option value="popular"><?php _e( 'Most Posts', 'myfossil' ); ?></option>
					<option value="unreplied"><?php _e( 'Unreplied', 'myfossil' ); ?></option>
		...
		<form action="" method="post" id="forum-topic-form" class="standard-form">
			<div id="new-topic-post">
				...
				<?php if ( bp_groups_auto_join() && !bp_group_is_member() ) : ?>
					<p><?php _e( 'You will auto join this group when you start a new topic.', 'myfossil' ); ?></p>
				<?php endif; ?>

				<p id="post-new"></p>
				<h4 class="page-header"><?php _e( 'Post a New Topic:', 'myfossil' ); ?></h4>

				<label><?php _e( 'Title:', 'myfossil' ); ?></label>
				<input type="text" name="topic_title" id="topic_title" value="" maxlength="100" />

				<label><?php _e( 'Content:', 'myfossil' ); ?></label>
				<textarea name="topic_text" id="topic_text"></textarea>

				<label><?php _e( 'Tags (comma separated):', 'myfossil' ); ?></label>
				<input type="text" name="topic_tags" id="topic_tags" value="" />

				<?php do_action( 'bp_after_group_forum_post_new' ); ?>

				<div class="submit">
					<input type="submit" class="btn btn-primary" name="submit_topic" id="submit" value="<?php esc_attr_e( 'Post Topic', 'myfossil' ); ?>" />
				</div>
