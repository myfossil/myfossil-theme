	...
	<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<div class="item-list-tabs" id="subnav" role="navigation">
			<ul class="nav nav-pills">
				<li>
					<a href="#post-topic-reply"><?php _e( 'Reply', 'myfossil' ); ?></a>
				</li>
		...
		<div id="topic-meta">
			<h3 class="page-header"><?php _e( 'Edit:', 'myfossil' ); ?> <?php bp_the_topic_title(); ?> (<?php bp_the_topic_total_post_count(); ?>)</h3>
		...
		<?php if ( bp_is_edit_topic() ) : ?>
			...
			<div id="edit-topic">
				...
				<label for="topic_title"><?php _e( 'Title:', 'myfossil' ); ?></label>
				<input type="text" name="topic_title" id="topic_title" value="<?php bp_the_topic_title(); ?>" maxlength="100" />

				<label for="topic_text"><?php _e( 'Content:', 'myfossil' ); ?></label>
				...
				<p class="submit"><input type="submit" class="btn btn-primary" name="save_changes" id="save_changes" value="<?php esc_attr_e( 'Save Changes', 'myfossil' ); ?>" /></p>
...
<?php else: ?>
	...
	<div class="clearfix"></div><div id="message" class="info alert alert-info">
		<p><?php _e( 'This topic does not exist.', 'myfossil' ); ?></p>
	</div>
