...
if (bp_has_forum_topics(bp_ajax_querystring('forums'))): ?>
	...
	<table class="forum">
		<thead>
			<tr>
				<th id="th-title"><?php
    _e('Topic', 'buddypress'); ?></th>
				<th id="th-postcount"><?php
    _e('Posts', 'buddypress'); ?></th>
				<th id="th-freshness"><?php
    _e('Freshness', 'buddypress'); ?></th>
    ...
    while (bp_forum_topics()):
        ...
        bp_the_topic_permalink(); ?>" title="<?php
        esc_attr_e('Permanent link to this post', 'buddypress'); ?>">
        ...
        bp_the_topic_title(); ?>
					...
					<p class="topic-meta">
						<span class="topic-by"><?php /* translators: "started by [poster] in [forum]" */

        printf(__('Started by %1$s', 'buddypress') , bp_get_the_topic_poster_avatar('height=20&width=20') . bp_get_the_topic_poster_name()); ?></span>
...
?>
        ...
        bp_the_topic_time_since_last_post(); ?></span>
					<p class="topic-meta">
						<span class="freshness-author">
							<a href="<?php
        bp_the_topic_permalink(); ?>"><?php
        bp_the_topic_last_poster_avatar('type=thumb&width=20&height=20'); ?></a>
							<?php
...
<?php
	...
	<div id="message" class="info">
		<p><?php
    _e('Sorry, there were no forum topics found.', 'buddypress'); ?></p>
	</div>
