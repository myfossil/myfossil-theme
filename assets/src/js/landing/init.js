...
(function($) {
    ...
    skel.init({
        ...
        breakpoints: {
            global: {
                range: '*',
                href: '/wp-content/themes/myfossil/static/css/style-homepage.min.css',
                containers: '60em',
                grid: {
                    gutters: {
                        vertical: '2em',
            ...
            wide: {
                range: '-1680',
                href: '/wp-content/themes/myfossil/static/css/style-wide.min.css'
            },
            normal: {
                range: '-1280',
                href: '/wp-content/themes/myfossil/static/css/style-normal.min.css',
                grid: {
                    gutters: {
                        vertical: '1.5em'
                    }
            ...
            narrow: {
                range: '-980',
                href: '/wp-content/themes/myfossil/static/css/style-narrow.min.css',
                containers: '90%'
            },
            narrower: {
                range: '-840',
                href: '/wp-content/themes/myfossil/static/css/style-narrower.min.css',
                grid: {
                    collapse: 1
                }
            },
            mobile: {
                range: '-736',
                href: '/wp-content/themes/myfossil/static/css/style-mobile.min.css',
                containers: '100%',
                grid: {
                    gutters: {
                        vertical: '1em'
            ...
            mobilep: {
                range: '-480',
                href: '/wp-content/themes/myfossil/static/css/style-mobilep.min.css',
                grid: {
                    collapse: 2
                }
            }
