                    ...
                    <?php if (is_user_logged_in()): ?>
                        <?php if (bp_activity_can_comment()): ?>
                            <a href="<?php bp_activity_comment_link(); ?>" class="btn btn-default button acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>">
                                <?php printf(__('Comment <span class="badge">%s</span>', 'buddypress') , bp_activity_get_comment_count()); ?>
                            </a>
                        <?php endif; ?>
                    ...
                    <?php if (is_user_logged_in() && bp_activity_can_comment()): ?>
                        ...
                        <form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form"<?php bp_activity_comment_form_nojs_display(); ?>>
                            ...
                            <div class="ac-reply-content">
                                ...
                                <input type="submit" name="ac_form_submit" class="btn btn-default" value="<?php esc_attr_e('Post', 'buddypress'); ?>" />
