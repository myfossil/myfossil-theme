...
<form action="<?php
bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
...
?>
	...
	<div id="whats-new-content_">
		<div id="whats-new-textarea" class="form-group">
			<textarea class="bp-suggestions" name="whats-new" id="whats-new" cols="50" rows="10"><?php
if (isset($_GET['r'])): ?>@<?php
    echo esc_textarea($_GET['r']); ?><?php
endif; ?></textarea>
		</div>

		<div id="whats-new-options">
			<div id="whats-new-submit">
				<button type="submit" class="btn btn-default" name="aw-whats-new-submit" id="aw-whats-new-submit"><?php
esc_attr_e('Post Update', 'buddypress'); ?></button>
			</div>
...
if (bp_is_active('groups') && !bp_is_my_profile() && !bp_is_group()): ?>
    ...
    _e('My Profile', 'buddypress'); ?></option>
						<?php
