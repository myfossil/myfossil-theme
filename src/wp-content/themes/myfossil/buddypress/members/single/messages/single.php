...
if (bp_thread_has_messages()): ?>
    ...
    bp_the_thread_delete_link(); ?>" title="<?php
    ...
    while (bp_thread_messages()):
        ...
        bp_the_thread_message_sender_avatar('type=thumb&width=30&height=30'); ?>
					...
					<?php
        if (bp_get_the_thread_message_sender_link()): ?>

						<strong><a href="<?php
            bp_the_thread_message_sender_link(); ?>" title="<?php
            bp_the_thread_message_sender_name(); ?>"><?php
            bp_the_thread_message_sender_name(); ?></a></strong>

					<?php
        else: ?>

						<strong><?php
            bp_the_thread_message_sender_name(); ?></strong>

					<?php
        endif; ?>

					<span class="activity"><?php
        bp_the_thread_message_time_since(); ?></span>
    ...
    bp_messages_form_action(); ?>" method="post" class="standard-form">
    ...
    bp_loggedin_user_avatar('type=thumb&height=30&width=30'); ?>
						...
						<strong><?php
    _e('Send a Reply', 'buddypress'); ?></strong>
					</div>
    ...
    esc_attr_e('Send Reply', 'buddypress'); ?>" id="send_reply_button"/>
					</div>
