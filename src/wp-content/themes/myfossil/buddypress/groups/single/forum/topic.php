...
if (is_user_logged_in()): ?>
				...
				<li>
					<a href="<?php
    bp_forum_topic_new_reply_link(); ?>" class="new-reply-link"><?php
    _e('New Reply', 'buddypress'); ?></a>
				</li>
...
if (bp_has_forum_topic_posts()): ?>
    ...
    while (bp_forum_topic_posts()):
        bp_the_forum_topic_post(); ?>
				...
				<li id="post-<?php
        bp_the_topic_post_id(); ?>" class="<?php
        bp_the_topic_post_css_class(); ?>">
					<div class="poster-meta">
						<a href="<?php
        bp_the_topic_post_poster_link(); ?>">
							<?php
        bp_the_topic_post_poster_avatar('width=40&height=40'); ?>
						</a>
						<?php
        ...
        do_action('bp_group_forum_post_meta'); ?>
						...
						<a href="#post-<?php
        bp_the_topic_post_id(); ?>" title="<?php
        esc_attr_e('Permanent link to this post', 'buddypress'); ?>">#</a>
					</div>
				</li>
	...
	<?php
		...
		<div id="message" class="info">
			<p><?php
    _e('There are no posts for this topic.', 'buddypress'); ?></p>
		</div>
    ...
    if (bp_get_the_topic_is_last_page()): ?>
        ...
        if (bp_get_the_topic_is_topic_open() && !bp_group_is_user_banned()): ?>
            ...
            if (bp_groups_auto_join() && !bp_group_is_member()): ?>
						<p><?php
                _e('You will auto join this group when you reply to this topic.', 'buddypress'); ?></p>
					<?php
            endif; ?>
            ...
            do_action('groups_forum_new_reply_before'); ?>
					...
					<h4><?php
            _e('Add a reply:', 'buddypress'); ?></h4>

					<textarea name="reply_text" id="reply_text"></textarea>

					<div class="submit">
						<input type="submit" name="submit_reply" id="submit" value="<?php
            esc_attr_e('Post Reply', 'buddypress'); ?>" />
					</div>
        ...
        elseif (!bp_group_is_user_banned()): ?>
				...
				<div id="message" class="info">
					<p><?php
            _e('This topic is closed, replies are no longer accepted.', 'buddypress'); ?></p>
				</div>
